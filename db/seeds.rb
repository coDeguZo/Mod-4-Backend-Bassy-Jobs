...
job_listing1 = JobListing.create(name: "Accountant", details: "placeholder text", salary: 80000, education_level: "Doctoral Degree", experience_level: "Senior", company_id: company1.id)
job_listing2 = JobListing.create(name: "TelePrompter", details: "placeholder text", salary: 100000, education_level: "Master's Degree", experience_level: "Mid", company_id: company4.id)
job_listing3 = JobListing.create(name: "Web Developer", details: "placeholder text", salary: 100000, education_level: "Bachelor's Degree", experience_level: "Mid", company_id: company2.id)
job_listing4 = JobListing.create(name: "Software Engineer", details: "placeholder text", salary: 90000, education_level: "Bachelor's Degree", experience_level: "Junior", company_id: company3.id)
job_listing5 = JobListing.create(name: "Mechanical Engineer", details: "placeholder text", salary: 150000, education_level: "Bachelor's Degree", experience_level: "Senior", company_id: company4.id)
job_listing6 = JobListing.create(name: "CEO", details: "placeholder text", salary: 500000, education_level: "Doctoral Degree", experience_level: "Senior", company_id: company4.id)
job_listing7 = JobListing.create(name: "Cashier", details: "placeholder text", salary: 120000, education_level: "Associate's Degree", experience_level: "Junior", company_id: company2.id)
job_listing8 = JobListing.create(name: "Software Engineer II", details: "placeholder text", salary: 120000, education_level: "Bachelor's degree", experience_level: "Mid", company_id: company1.id)
job_listing9 = JobListing.create(name: "Bank Teller", details: "placeholder text", salary: 60000, education_level: "Bachelor's degree", experience_level: "Mid", company_id: company3.id)
job_listing10 = JobListing.create(name: "Software Engineer III", details: "placeholder text", salary: 200000, education_level: "Bachelor's degree", experience_level: "Senior", company_id: company2.id)
