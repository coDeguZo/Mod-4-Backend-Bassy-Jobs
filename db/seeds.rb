...
job_listing6 = JobListing.create(name: "CEO", details: "placeholder text", salary: 500000, education_level: "Ph.D in Being A Boss", status: "Open", experience_level: "Senior", company_id: company4.id)
job_listing7 = JobListing.create(name: "Cashier", details: "placeholder text", salary: 120000, education_level: "Associates Degree or Related Experience", status: "Open", experience_level: "Junior", company_id: company2.id)
job_listing8 = JobListing.create(name: "Software Engineer II", details: "placeholder text", salary: 120000, education_level: "Bachelor's in computer science or related field preferred", status: "Open", experience_level: "Mid", company_id: company1.id)
job_listing9 = JobListing.create(name: "Bank Teller", details: "placeholder text", salary: 60000, education_level: "Bachelor's in Banking", status: "Open", experience_level: "Mid", company_id: company3.id)
job_listing10 = JobListing.create(name: "Software Engineer III", details: "placeholder text", salary: 200000, education_level: "Bachelor's in computer science or related field preferred", status: "Open", experience_level: "Senior", company_id: company2.id)
